...
%
%
%   This MATLAB m-file generates the data for the unit step response
%   plots for transitional filters (Figure 8.7) in
%
%
...
%
%
% STEP SIX:  Compute the unit step responses
%
  t = (0:1:499)/19.96;
  [stpBU,x] = step(NUM,DENBU,t);
  stpBU = real(stpBU/scBU);
  [stpBE,x] = step(NUM,DENBE,t);
  stpBE = real(stpBE/scBE);
  [stpTR,x] = step(NUM,DENTR,t);
  stpTR = real(stpTR/scTR);
%
%
%
% STEP SEVEN:  Plot the results
%
  plot(t,stpBU,t,stpBE,t,stpTR)
%  axis([0 2 0 50])
  xlabel('Time in Seconds')
  ylabel('Amplitude')
  grid
  title('The Data for Figure 8.7 (Transitional Filters)')
%
%
%
%  End of FI8_7dat.m
