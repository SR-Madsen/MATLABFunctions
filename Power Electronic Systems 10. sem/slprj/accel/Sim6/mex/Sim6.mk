...
MAKECMD         = /opt/MATLAB/R2021b/bin/glnxa64/gmake
HOST            = UNIX
BUILD           = yes
SYS_TARGET_FILE = any
...
MODEL                   = Sim6
MODULES                 = Sim6_acc.c Sim6_acc_data.c rtGetInf.c rtGetNaN.c rt_look.c rt_look1d.c rt_nonfinite.c c_mexapi_version.c
PRODUCT                 = $(RELATIVE_PATH_TO_ANCHOR)/Sim6_acc.mexa64
MAKEFILE                = Sim6.mk
MATLAB_ROOT             = /opt/MATLAB/R2021b
ALT_MATLAB_ROOT         = /opt/MATLAB/R2021b
START_DIR               = /home/sebastian/Desktop/Git/MATLABFunctions/Power\ Electronic\ Systems\ 10.\ sem
S_FUNCTIONS_LIB         = 
NUMST                   = 6
NCSTATES                = 29
COMPUTER                = GLNXA64
...
COMPILE_FLAGS_OTHER     = -Wno-implicit-function-declaration -msse2
SYSTEM_LIBS             = -L"/opt/MATLAB/R2021b/bin/glnxa64" -lmwipp -lut -lmwmathutil -lmwsl_simtarget_instrumentation -lmwsl_simtarget_core -lmwsl_fileio -lmwsigstream -lmwslexec_simlog -lmwsl_AsyncioQueue -lmwsf_runtime -lmwsimulink -lmwslexec_simbridge -lmwstringutil -lemlrt -lmwslio_core -lmwslio_clients -lmwsl_services -lmx -lmex
...
Sim6_acc.o : $(START_DIR)/slprj/accel/Sim6/Sim6_acc.c
	$(CC) -c $(CFLAGS) $(GCC_WALL_FLAG_MAX) $(START_DIR)/slprj/accel/Sim6/Sim6_acc.c

Sim6_acc_data.o : $(START_DIR)/slprj/accel/Sim6/Sim6_acc_data.c
	$(CC) -c $(CFLAGS) $(GCC_WALL_FLAG_MAX) $(START_DIR)/slprj/accel/Sim6/Sim6_acc_data.c

rtGetInf.o : $(START_DIR)/slprj/accel/Sim6/rtGetInf.c
	$(CC) -c $(CFLAGS) $(GCC_WALL_FLAG_MAX) $(START_DIR)/slprj/accel/Sim6/rtGetInf.c

rtGetNaN.o : $(START_DIR)/slprj/accel/Sim6/rtGetNaN.c
	$(CC) -c $(CFLAGS) $(GCC_WALL_FLAG_MAX) $(START_DIR)/slprj/accel/Sim6/rtGetNaN.c

rt_look.o : $(START_DIR)/slprj/accel/Sim6/rt_look.c
	$(CC) -c $(CFLAGS) $(GCC_WALL_FLAG_MAX) $(START_DIR)/slprj/accel/Sim6/rt_look.c

rt_look1d.o : $(START_DIR)/slprj/accel/Sim6/rt_look1d.c
	$(CC) -c $(CFLAGS) $(GCC_WALL_FLAG_MAX) $(START_DIR)/slprj/accel/Sim6/rt_look1d.c

rt_nonfinite.o : $(START_DIR)/slprj/accel/Sim6/rt_nonfinite.c
	$(CC) -c $(CFLAGS) $(GCC_WALL_FLAG_MAX) $(START_DIR)/slprj/accel/Sim6/rt_nonfinite.c
