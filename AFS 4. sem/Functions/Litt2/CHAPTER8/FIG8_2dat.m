...
%
%
%   This MATLAB m-file generates the data for the detailed magnitude
%   frequency response plots across the passband for transitional
%   filters (Figure 8.2) in
%
%
...
%
%
% STEP SIX:  Compute the magnitude frequency response
%
  w = (0:1:999)/500;  
...
%
  plot(w,DbBU,w,DbBE,w,DbTR)
  axis([0 2 -6 0.5])
  xlabel('Radian Frequency')
  ylabel('Magnitude in dB')
  grid
  title('The Data for Figure 8.2 (Transitional Filters)')   
%
%
%
%  End of FI8_2dat.m
